...
interface LoginScreenProps {
  /** Optional error string surfaced from /auth/callback?error=... */
  error?: string | null
}
...
export function LoginScreen({ error }: LoginScreenProps) {
  ...
  const onContinue = () => {
    setRedirecting(true)
    // Full-page navigation — Google OAuth requires a top-level redirect.
      ...
      <div className="login-card">
        <div className="login-brand">
          <div className="login-brand__logo">
            <BrandLogo variant="icon" alt="Publish Harbor" />
          </div>
