...
export function AssetsPage({ onNavigate }: AssetsPageProps) {
    ...
    return (
      <div className="assets-page">
        ...
        <div className="empty-state">
          ...
          <p>Connect your Meta account first to manage Facebook Pages and linked Instagram professional accounts.</p>
          <button
  ...
  return (
    <div className="assets-page">
      ...
      {/* Linked Instagram professional accounts */}
      <section className="assets-section">
        <div className="section-header">
          <div className="section-title">
        ...
        <div className="assets-list">
          <h3 className="list-subtitle">Available through connected Facebook Pages</h3>
          {metaConnection.instagramAccounts.length > 0 ? (
            ...
            <div className="section-empty">
              <p>No linked Instagram professional accounts are available yet. Connect a Facebook Page that has a linked Instagram professional account.</p>
            </div>
          )}
        </div>
