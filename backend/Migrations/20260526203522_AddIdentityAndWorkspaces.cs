        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalAuthUserId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_AuthProvider_ExternalAuthUserId",
                table: "AppUsers",
                columns: new[] { "AuthProvider", "ExternalAuthUserId" },
                unique: true);
